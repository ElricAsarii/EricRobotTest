...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/OvanimeIndonesia'),
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                ...
                                url="https://t.me/OvanimeIndonesia",
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "updates_channel_link_btn"),
                                url="https://t.me/Marin_Kitagawa_official",
                            ),
                            InlineKeyboardButton(
            ...
            if args[0].lower() == "help":
                ...
                help_buttons.append(
                    [
                        ...
                        InlineKeyboardButton(
                            text="Support", url="https://t.me/OvanimeIndonesia"
                        ),
                    ]
                )
                send_help(
